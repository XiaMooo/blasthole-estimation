...
def run(data,
        ...
        project=ROOT / 'runs/val/temp',  # save to project/name
    ...
    for i in range(11):
        for j in range(1):
            ...
            confusion_matrix.write((conf_thres, iou_thres, mp, mr, map50, map), fout)
            # Plots
            if plots:
                # Before:
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/blastHole.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/val/temp', help='save to project/name')
